  ...
  render() {
        ...
        <Link to={'/product/' + item._id}>
          <figure>
            ...
            <figcaption className="text-center">
              {item.name}<br />
              <span className="price">{this.formatPrice(item.price)}</span>
            </figcaption>
          </figure>
        </Link>
        <img
    ...
    const categories = [
      ...
      { id: 6, name: 'Laptop', image: 'https://bizweb.dktcdn.net/thumb/medium/100/329/122/products/laptop-gaming-msi-sword-16-hx-b14vfkg-045vn.jpg?v=1720089128953'
        ,link :'/product/category/682d421da3ca52aba9c1dceb' },
...
.gradient-text {
  ...
  margin: 15px;
  cursor: pointer; /* Ensures hand icon appears on hover */
...
.product-card:hover .promo-info {
  ...
  outline: 1px solid #ddd;
        ...
        <div className="align-center new-products">
          <h2 className="gradient-text">SẢN PHẨM MỚI</h2>
          {newprods}
        </div>
...
<div class="container-showroom">
    ...
    <div class="showrooms">
        ...
        <li><a href="https://www.google.com/maps/search/?api=1&query=12+Nguyễn+Văn+Bảo,+phường+4,+Quận+Gò+Vấp,+TP.HCM" target="_blank" rel="noopener noreferrer"><i class="fas fa-map-marker-alt"></i> 12 Nguyễn Văn Bảo, phường 4, Quận Gò Vấp, TP.HCM</a></li>
        <li><a href="https://www.google.com/maps/search/?api=1&query=25A+Mai+Thị+Lựu,+phường+Đa+Kao,+Quận+1,+TP.HCM" target="_blank" rel="noopener noreferrer"><i class="fas fa-map-marker-alt"></i> 25A Mai Thị Lựu, phường Đa Kao, Quận 1, TP.HCM</a></li>
        <li><a href="https://www.google.com/maps/search/?api=1&query=102+Trường+Chinh,+phường+Tân+Hưng+Thuận,+Quận+12,+TP.HCM" target="_blank" rel="noopener noreferrer"><i class="fas fa-map-marker-alt"></i> 102 Trường Chinh, phường Tân Hưng Thuận, Quận 12, TP.HCM</a></li>
        <li><a href="https://www.google.com/maps/search/?api=1&query=68A+Hoàng+Hoa+Thám,+phường+7,+Quận+Bình+Thạnh,+TP.HCM" target="_blank" rel="noopener noreferrer"><i class="fas fa-map-marker-alt"></i> 68A Hoàng Hoa Thám, phường 7, Quận Bình Thạnh, TP.HCM</a></li>
        <li><a href="https://www.google.com/maps/search/?api=1&query=47+Lê+Văn+Việt,+phường+Hiệp+Phú,+Thành+phố+Thủ+Đức,+TP.HCM" target="_blank" rel="noopener noreferrer"><i class="fas fa-map-marker-alt"></i> 47 Lê Văn Việt, phường Hiệp Phú, Thành phố Thủ Đức, TP.HCM</a></li>
...
<div class="bottom-info">
  ...
  <p>MST: 0312732474. Chủ sở hữu: Nguyễn Hữu Trưởng - Điện thoại: 0385 167 174 (miễn phí) - Email: nguyenhuutruong1107@gmail.com - Bản quyền thuộc về TechZone.</p>
</div>
  ...
  <div className="contact-option">
    <a href="https://zalo.me/0385167174" target="_blank" rel="noopener noreferrer">
  ...
  <div className="contact-option">
    ...
    <a href="tel:0348177164" className="text-link">
      <div className="text-container">
        ...
        <span className="sub-text">0385167174 (8h-24h)</span>
      </div>
    </a>
  </div>
  ...
  <div className="contact-option">
    ...
    <a href="tel:0348177164" className="text-link">
      <div className="text-container">
        ...
        <span className="sub-text">0385167174 (8h-21h)</span>
      </div>
    </a>
  </div>
</div>
